...
export default async function handler(req, res) {
    ...
    if (req.method === "GET") {
        ...
        const { itemName, itemPrice, category, circle, circleIdString, ownerId, imageBase64, description } = req.body;
        if (!itemName || !itemPrice || !category || !circle || !circleIdString || !ownerId || !imageBase64) {
